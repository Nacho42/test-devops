...
import com.opentrends.apibuilder.configuration.FeignConfiguration;
...
@FeignClient(name = "jenkins", url = "${com.opentrends.api-builder.providers.jenkins.url}", configuration = FeignConfiguration.class)
